import type { VaultInstanceId } from "@lena/core";

// Opaque evidence and activation authority are intentionally process-local.
// Consumers must load one physical @lena/vault module instance. Duplicate
...
export function getRuntimeActiveVaultInstance(registry: object): VaultInstanceId | undefined {
...
export function preserveRuntimeActiveVaultInstance(source: object, target: object): void {

...
export const gpsDetectorVersionSchema =
	GpsVersionSchema.brand<'GpsDetectorVersion'>()
export const gpsPolicyVersionSchema =
	GpsVersionSchema.brand<'GpsPolicyVersion'>()
...
export function parseGpsDetectorVersion(
	value: unknown
): Result<GpsDetectorVersion, LenaError> {
...
export function parseGpsPolicyVersion(
	value: unknown
): Result<GpsPolicyVersion, LenaError> {
...
export function parseGpsObservationId(
	value: unknown
): Result<GpsObservationId, LenaError> {

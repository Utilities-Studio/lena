...
import { countryCodeSchema, gpsDetectorVersionSchema, gpsObservationIdSchema } from "./identifiers";
...
export type PersistableCountryObservation = z.output<typeof persistableCountryObservationSchema>;
...
export function parsePersistableCountryObservation(
  ...
  if (!parsed.success) {
    return err(new LenaError("invalid_input", { boundary: "gps_persistable_observation" }));
  }

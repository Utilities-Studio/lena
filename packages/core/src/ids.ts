...
export function parseVaultInstanceId(value: unknown): Result<VaultInstanceId, LenaError> {
  return parseId(value, vaultInstanceIdSchema, "VaultInstanceId");
}

export function parseGenerationId(value: unknown): Result<GenerationId, LenaError> {

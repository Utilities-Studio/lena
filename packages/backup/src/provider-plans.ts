...
const immutableTransportUploadPlanBrand: unique symbol = Symbol(
	'ImmutableTransportUploadPlan'
)
...
const immutableTransportDeletePlanBrand: unique symbol = Symbol(
	'ImmutableTransportDeletePlan'
)
...
export function isAuthorizedImmutableTransportUploadPlan(
	...
	return (
		typeof value === 'object' &&
		value !== null &&
		authorizedUploadPlans.has(value)
	)
}
...
export function isAuthorizedImmutableTransportDeletePlan(
	...
	return (
		typeof value === 'object' &&
		value !== null &&
		authorizedDeletePlans.has(value)
	)
}
